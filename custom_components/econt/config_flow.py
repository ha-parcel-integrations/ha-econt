"""Config flow for the Econt parcel tracker integration."""
...
class EcontConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle the UI-driven configuration flow for the Econt integration."""
    ...
    ) -> EcontOptionsFlowHandler:
        """Return the options flow handler."""
        return EcontOptionsFlowHandler()

    async def async_step_user(
        self, user_input: dict[str, Any] | None = None
    ) -> ConfigFlowResult:
        """Create the Econt hub — single instance, no input needed.
        ...
        the ``econt.track_parcel`` service or a dashboard button.
...
class EcontOptionsFlowHandler(OptionsFlow):
