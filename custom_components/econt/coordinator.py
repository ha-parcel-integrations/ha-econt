"""Coordinator for the Econt parcel tracker integration.
...
from .api import EcontApiClient, EcontApiError
from .const import (
...
class EcontCoordinator(DataUpdateCoordinator[list[dict]]):
