...
def test_code_is_trimmed_but_not_reformatted_and_any_non_empty_code_is_accepted():
    assert normalize_tracking_code(" 1055215517880 ") == "1055215517880"
    assert valid_tracking_code("1055215517880")
    assert valid_tracking_code("econt")
...
async def test_options_deduplicates_numeric_codes(hass):
